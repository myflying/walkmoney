...
public class BodyInfoModelImp extends BaseModel implements BodyInfoModel<BodyInfoRet> {
    ...
    @Override
    public void getBodyInfo(String userId, IBaseRequestCallBack<BodyInfoRet> iBaseRequestCallBack) {
        ...
        mCompositeSubscription.add(bodyInfoService.getBodyInfo(requestBody)
