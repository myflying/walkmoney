...
public class CircleTimeView extends View {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        try {
            ...
            mMarkLineColor = attrs.getColor(R.styleable.CircleTimeView_ctvMarkLineColor, DEFAULT_LINE_COLOR);
            mHighlightMarkLineColor = attrs.getColor(R.styleable.CircleTimeView_ctvHighlightMarkLineColor, DEFAULT_HIGHLIGHT_LINE_COLOR);
