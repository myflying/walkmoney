...
public class TaskActivity extends BaseActivity implements IBaseView, ReceiveGoldDialog.GoldDialogListener, SignTodayDialog.SignDayListener, LoginDialog.LoginListener {
    ...
    public Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 2:
                    isCanShowSign = false;
                    signTodayDialog = new SignTodayDialog(TaskActivity.this, R.style.common_dialog);
                    signTodayDialog.setSignDayListener(TaskActivity.this);
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        taskInfoAdapter = new TaskInfoAdapter(this, null);
        mTaskInfoListView.setLayoutManager(new LinearLayoutManager(this));
        mTaskInfoListView.addItemDecoration(new NormalDecoration(ContextCompat.getColor(this, R.color.line1_color), 2));
...
//                    }
                    ...
                    if (taskInfo.getTaskType().equals("invite")) {
                        ...
                        if (taskInfo.getState() == 1) {
                            Intent intent = new Intent(TaskActivity.this, InviteFriendActivity.class);
                    ...
                    if (taskInfo.getTaskType().equals("bind_sj")) {
                        taskType = "bind_sj";
                        if (taskInfo.getState() == 1) {
                            Intent intent = new Intent(TaskActivity.this, BindPhoneActivity.class);
                    ...
                    if (taskInfo.getTaskType().equals("bind_wx")) {
                        taskType = "bind_wx";
                        if (taskInfo.getState() == 1) {
                            mShareAPI.getPlatformInfo(TaskActivity.this, SHARE_MEDIA.WEIXIN, authListener);
                        }
                        if (taskInfo.getState() == 2) {
                            taskGetGold(taskInfo);
                        }
                    ...
                    if (taskInfo.getTaskType().equals("invite_code")) {
                        ...
                        if (taskInfo.getState() == 1) {
                            Intent intent = new Intent(TaskActivity.this, FillInCodeActivity.class);
                    ...
                    if (taskInfo.getTaskType().equals("target_num")) {
                        taskType = "target_num";
                        if (taskInfo.getState() == 1) {
                            Intent intent = new Intent(TaskActivity.this, BodyDataActivity.class);
                    ...
                    if (taskInfo.getTaskType().equals("first_cash")) {
                        taskType = "first_cash";
                        if (taskInfo.getState() == 1) {
                            Intent intent = new Intent(TaskActivity.this, CashActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        taskInfoPresenterImp.taskList(App.mUserInfo != null ? App.mUserInfo.getId() : "", 1);
    }
        ...
        if (tData != null) {
            if (tData instanceof TaskInfoWrapperRet && ((TaskInfoWrapperRet) tData).getCode() == Constants.SUCCESS) {
                ...
                if (((TaskInfoWrapperRet) tData).getData() != null) {
                    ...
                    mTotalGoldNumTv.setText(signTaskInfo.getGold() + "");
                    mMoneyTv.setText("≈" + MatrixUtils.getPrecisionMoney(money) + "元");
            ...
            if (tData instanceof UserInfoRet) {
                ...
                if (((UserInfoRet) tData).getCode() == Constants.SUCCESS) {
                    ...
                    if (taskType.equals("bind_sj") || taskType.equals("bind_wx")) {
                        ...
                        App.isLogin = true;
                        Toasty.normal(this, taskOrLogin == 1 ? "登录成功" : "绑定成功").show();
                    }
            ...
            if (tData instanceof TakeGoldInfoRet) {
                if (((TakeGoldInfoRet) tData).getCode() == Constants.SUCCESS) {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (receiveGoldDialog == null) {
                                receiveGoldDialog = new ReceiveGoldDialog(TaskActivity.this, R.style.gold_dialog);
                                receiveGoldDialog.setGoldDialogListener(TaskActivity.this);
                            }
                    ...
                    mTotalGoldNumTv.setText(tempGoldInfo.getGold() + "");
                    mMoneyTv.setText("≈" + MatrixUtils.getPrecisionMoney(tempGoldInfo.getAmount()) + "元");
                } else {
                    Toasty.normal(this, ((TakeGoldInfoRet) tData).getMsg()).show();
                }
            }
    ...
    UMAuthListener authListener = new UMAuthListener() {
        ...
        public void onError(SHARE_MEDIA platform, int action, Throwable t) {
            ...
            Toasty.normal(TaskActivity.this, "授权失败").show();
            if (progressDialog != null && progressDialog.isShowing()) {
                progressDialog.dismiss();
            }
        }
        ...
        public void onCancel(SHARE_MEDIA platform, int action) {
            Toasty.normal(TaskActivity.this, "授权取消").show();
            if (progressDialog != null && progressDialog.isShowing()) {
                progressDialog.dismiss();
            }
        }
    ...
    void makeMoney() {
        Intent intent = new Intent(this, MakeMoneyActivity.class);
            ...
            public void onRewardVideoAdLoad(TTRewardVideoAd ad) {
                ...
                mttRewardVideoAd.setRewardAdInteractionListener(new TTRewardVideoAd.RewardAdInteractionListener() {
                    ...
                    public void onRewardVerify(boolean rewardVerify, int rewardAmount, String rewardName) {
                        ...
                        if (adTaskInfo != null && (taskType.equals("ad") || taskType.equals("login"))) {
