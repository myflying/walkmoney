...
import com.ydys.elsbballs.util.MyTimeUtil;
    ...
    protected void convert(BaseViewHolder holder, TaskInfo taskInfo) {
        ...
        if (taskInfo.getTaskType().indexOf("experience") > -1) {
            if(taskInfo.getState() < 3) {
                tempTitle = taskInfo.getTitle() + "(<font color='#ff5555'>" + taskInfo.getHasCompleteNum() + "分钟" + "</font>/" + taskInfo.getNum() + "分钟)";
            }else{
                tempTitle = taskInfo.getTitle() + "(<font color='#333333'>" + taskInfo.getHasCompleteNum() + "分钟" + "</font>/" + taskInfo.getNum() + "分钟)";
            }
        }
        ...
        if (taskInfo.getState() == 1) {
            ...
            holder.setText(R.id.btn_get_now, "");
            ...
            holder.setBackgroundRes(R.id.btn_get_now, R.mipmap.done_over_bg);
